...
// Attach click event to markers for selection
...
document.getElementById("edit").addEventListener("click", function() {
    if (selectedMarker) { // Ensure a marker is selected
        // Perform edit action on the selected marker
        editDataTool(selectedMarker);

        selectedMarker = null; // Reset selection after editing
    } else {
        alert("Please select a marker before clicking Edit.");
    }
});
